    ...
    <div class="row py-3">
      <div class="col-12">
        ...
        <div>
          ...
          <p>{{r_name}}</p>
          <p>{{r_company}}</p>
          <p v-if="cod">COD: {{cod}}</p>
        </div>
        <hr>
        <div>
          <label v-if="cod" class="form-label">Cash Received:</label>
          <input v-if="cod" class="form-control mb-3" type="text" v-model.number ="amount"/>
